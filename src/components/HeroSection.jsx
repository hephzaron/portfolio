...
const HeroDescription = () => (
  <p className="text-lg md:text-xl text-muted-foreground max-2-2xl mx-auto opacity-0 animate-fade-in-delay-3">
    I specialize in designing efficient hardware-software solutions for reliable, scalable,
    and energy-optimized systems
  </p>
);
 ...
 * @description Hero banner section that introduces the user
